...
public final class HttpUtils {
     ...
     * @throws IOException IO异常
     */
    public static String get(String url, Map<String, String> queryStringMap, HttpHost proxy) throws IOException {
        ...
        HttpResponse response = doExecute(get, proxy);
     ...
     * @throws IOException IO异常
     */
    public static HttpResponse doExecute(HttpRequestBase request, HttpHost proxy) throws IOException {
        HttpClient client = getClientInstance();
        RequestConfig requestConfig = getConfigInstance(proxy);
    ...
    private static RequestConfig getConfigInstance(HttpHost proxy) {
